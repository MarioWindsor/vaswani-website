---
title: Careers
layout: layouts/careers.liquid
cover:
  background: /media/banner-1.jpg
intro:
  label: Join Us
  heading: Our People are Our Strength
  sub-heading: At our core, we are a family of visionaries and craftsmen.
  description: We believe a company is only as strong as its team, nurturing a culture built on trust, respect, and collaboration — where every individual is valued and empowered to grow.
cta:
  label: Send in your resume to
  email: careers@vaswanigroup.com
  description: We have a place for those who are passionate about their craft. Whether you're a seasoned professional or just starting your journey, explore how you can contribute to our vision.
opportunities:
